  ...
  return (
    <div className="Order">
      <div className="Order__top">
        ...
        <div className="Order__code">Orden: <i>{data.orderCode}</i></div>
        <div className="Order__status"><span>{parseInt(data.paid) === 1 ? 'Pagado' : 'Pendiente'}</span></div>
      </div>
      <div className="Order__address"><b>Dirección de envío:</b> {data.streetName}, {data.address}, {data.city}, {data.state}, {data.zip_code}</div>
